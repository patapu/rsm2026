...
ต่อให้เนื้อหานั้นดูเหมือนจะเข้าเกณฑ์ `description` หรือกราฟก็ตาม เช่นเดียวกับ "เป็นกราฟ" /
"as a chart" → ใช้ `resume-chart` และ "ไทม์ไลน์" / "timeline" → ใช้ `kind: "timeline"`
อย่าเปลี่ยนรูปแบบที่ user ขอมาเป็นอย่างอื่นเพราะคิดว่าสวยกว่า
